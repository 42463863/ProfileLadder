...
#' the Cameron Mutual Insurance company from the period 1988 -- 1997.  The data matrix contains ten origin/occurrence 
...
#' 
#' The run-off triangle (the upper-left triangular part of the data matrix) contains only positive increments 
#' making the triangle suitable for the standard modelling approach---the over-dispersed Poisson model (GLM regression). 
#' 
...
#' The Cameron Mutual Insurance data matrix is fully observed to allow for some goodness-of-fit evaluations 
#' 
#' @name CameronMutual
#' 
#' @docType data
